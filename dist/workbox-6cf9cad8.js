    ...
    (t.NetworkFirst = class extends v {
      constructor(t = {}) {
        super(t),
          ...
          (this.D = t.networkTimeoutSeconds || 0);
      }
      async L(t, e) {
        const n = [],
          r = [];
        ...
        const o = this.F({ timeoutId: i, request: t, logs: n, handler: e });
        r.push(o);
      ...
      async F({ timeoutId: t, request: e, logs: s, handler: n }) {
        let r, i;
        try {
